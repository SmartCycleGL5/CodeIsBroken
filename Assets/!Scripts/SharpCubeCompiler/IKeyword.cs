...
namespace SharpCube
{
    ...
    {
        public Action<Encapsulation, Line, Properties> create { get; set; }

        public Initializer(string key, string color, Action<Encapsulation, Line, Properties> create) : base(key, color)
        {
            this.create = create;
        }
    }
