...
namespace RoslynCSharp.CodeEditor
{
    ...
    /// </summary>
    [Serializable]
    [CreateAssetMenu(fileName = "Code Editor Theme", menuName = "Roslyn C# 2.0/Code Editor/Editor Theme")]
    public class CSharpCodeEditorTheme : ScriptableObject
    {
        // Public
        /// <summary>
        ...
        /// </summary>
        public static CSharpCodeEditorTheme DefaultTheme
        {
            get { return CreateInstance<CSharpCodeEditorTheme>(); }
        }
    }
}
