...
namespace RoslynCSharp.Demo
{
    ...
    public abstract class MazeCrawler : MonoBehaviour
    {
        ...
        // Public
        /// <summary>
        /// The breadcrumb game object that is dropped at every position.
        /// </summary>
        ...
        // Methods
        /// <summary>
        /// When overridden should return the <see cref="MazeDirection"/> that the crawler should move given the current state
        /// </summary>
        ...
        private void Update()
        {
            if (HasArrived(targetPosition) == true)
            {
                ...
                // Calculate the current index position
                        ...
                        case MazeDirection.Up:
                            {
                                // Validate move
                                if (canMoveUp == false)
                                    throw new InvalidOperationException("Invalid decision: Cannot move up. Game will stop!");
                        ...
                        case MazeDirection.Down:
                            {
                                ...
                                if (canMoveDown == false)
                                    throw new InvalidOperationException("Invalid decision: Cannot move down. Game will stop!");
                        ...
                        case MazeDirection.Left:
                            {
                                ...
                                if (canMoveLeft == false)
                                    throw new InvalidOperationException("Invalid decision: Cannot move left. Game will stop!");
                        ...
                        case MazeDirection.Right:
                            {
                                ...
                                if (canMoveRight == false)
                                    throw new InvalidOperationException("Invalid decision: Cannot move right. Game will stop!");
        ...
        private bool CanMoveInDirection(MazeDirection direction)
        {
            ...
            if (hit.collider != null)
            {
                ...
                {
                    enabled = false;
                    UnityEngine.Debug.Log("Congratulations! Your crawler successfully escaped the maze");
                    return false;
                }
